...
get_header(); ?>
		...
		<section id="primary">
			...
			// remove the Announcements, In Synthesis categories from flow
			
			$skipcats = array(456,457);
			// query_posts( 'cat=-456,-457' );
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php if ( in_category( $skipcats ) ) continue; // skip categories ?>
